...
const MapPage = () => {
    ...
    if (mapData) {
        for (const screenshot in mapData.screenshots) {
            carouselImages.push({src: mapData.screenshots[screenshot]})
        }
    }
            ...
            <main className='main-content-wrapper'>
                <div className="map-page-header">
                    ...
                    <div className="map-metadata">
                        <span className="map-title">{mapData.display_name}</span>
                        <span className="map-type" title={'Map type'}><img src={MapIcon} alt=""/> {mapData.map_type}</span>
                        <span className="map-dlc" title={'Map DLC'}><img src={PackageIcon} alt=""/> {mapData.dlc}</span>
                    ...
                    <img src={mapData.screenshots.preview_image} alt=""/>
